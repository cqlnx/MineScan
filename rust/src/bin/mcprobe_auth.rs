...
async fn get_auth_mode(host: &str, port: u16, protocol: i32) -> Result<i32> {
    if protocol < MIN_PROTOCOL_VERSION {
        return Err(anyhow!("Protocol version {} too old", protocol));
    }
...
async fn main() -> Result<()> {
    ...
    println!("🔍 Minecraft Server Scanner (Auth Mode)");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        ...
        let handle = tokio::spawn(async move {
            ...
            if success {
                if let Some(version) = &result.version {
                    let auth_str = match result.auth_mode {
                        Some(0) => "Offline",
                        Some(1) => "Online",
                        Some(2) => "Whitelist",
                        _ => "Unknown",
